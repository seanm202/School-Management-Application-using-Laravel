...
$.ajaxSetup({
    ...
    $('#clearAllSessionsForReal').on('submit', function (e) {
...
<div id="errorShowBox" class="errorshow-box">
    <div id="contentOfErrorShowBox"></div>
        ...
        <form method="POST" action="{{ route('login') }}" id="realLoginForm">
            @csrf
...
<div class="unset-section">
    <form method="POST" action="{{ route('unsetAllSessions') }}" id="clearAllSessionsForReal">
        @csrf
