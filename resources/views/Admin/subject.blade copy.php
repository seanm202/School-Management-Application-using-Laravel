...
// let roleupdateurl = "/updateRole";
    ...
    <td><button type="button" class="btn btn-primary form-control"
            data-bs-grade-id="${subjectCategory.departmentId}"
    ...
    console.log("Response:", jqXHR.responseText); tableForDisplayingSubjectList
...
//             $.ajax({
//                 url: "{{ route('getSubjectDetailsByAJAX') }}",
//                 method: "GET", 
//                 dataType: "json", 
//                 success: function(data) {
//                     console.log(data); 
...
//         data-bs-firstname="${student.firstname}"
//         data-bs-lastname="${student.lastname}"
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="mb-3">
          <label class="form-label">Rowboat ID</label>
          <input type="text" class="form-control" id="modal-rowboat-id">
        </div>
      </div>
    </div>
  </div>
