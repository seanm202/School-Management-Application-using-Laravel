...
// let roleupdateurl = "/updateRole";
    ...
    <td><button type="button" class="btn btn-primary form-control selectForAssignClassRoomAStudent" data-bs-toggle="modal" data-bs-studentId="${student.studentId}" data-target="#assignStudentsToClasses">
                                              Select classroom
                                            </button></td>
            </tr>
               `;
                           ...
                           <div class="modal-dialog" role="document">
                             <div class="modal-content">
                               <div class="modal-header">
                                 <h5 class="modal-title" id="exampleModalStudentFullName">Name : {{$studentsNotAssignedToClass->firstName}} {{$studentsNotAssignedToClass->lastName}}</h5>
                                   <h5 class="modal-title" id="exampleModalStudentEmail">Email : {{$studentsNotAssignedToClass->Email}}</h5>
                                 <h5 class="modal-title" id="exampleModalStudentPhone">Phone : {{$studentsNotAssignedToClass->Phone}}</h5>
