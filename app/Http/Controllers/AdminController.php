...
class AdminController extends Controller
{
  ...
  //
  // }
  public function getDailyRegister(Request $request)
  {
    $dailyRegister = \App\Models\Attendence::where('dailyReg', '==', $request->todayDate)->get();
  ...
  {
    $dailyRegister = \App\Models\Attendence::where('dailyReg', '==', $request->todayDate)
  ...
  public function getCurrentDayStudentAbsentDetails(Request $request)
  {
    $dailyRegister = \App\Models\Attendence::where('dailyReg', '==', $request->todayDate)
